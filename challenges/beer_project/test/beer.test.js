let BeerSong = require('../lib/beer.js');
...
describe("Beer Song", () => {
  test("first verse", () => {
    ...
    expect(BeerSong.verses(99)).toBe(expected);
  });
  ...
  test("another verse", () => {
    ...
    expect(BeerSong.verses(3)).toBe(expected);
  });
  ...
  test("2 bottles verse", () => {
    ...
    expect(BeerSong.verses(2)).toBe(expected);
  });
  ...
  test("1 bottle verse", () => {
    ...
    expect(BeerSong.verses(1)).toBe(expected);
  });
  ...
  test("no bottles verse", () => {
    ...
    expect(BeerSong.verses(0)).toBe(expected);
  });
